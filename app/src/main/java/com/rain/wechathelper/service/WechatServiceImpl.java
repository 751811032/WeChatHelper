...
////
////		Log.d("wechatserviceimp",request.toString());
...
////		Log.d("wechatserviceimp",request.toString());
////
////		request.header("user-Agent","Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; rv:1.9.2.6) Gecko/20100625 Firefox/3.6.6 Greatwqs");
////		String res = request.body();
////		request.disconnect();
////		Log.d("wechatserviceimp11",res);
...
////			} catch (Exception e){
////				Log.e("wechatserviceimp", e.toString());
////			}
////		}
////
////		if(null == url){
...
////			Log.i("wechatserviceimp","你有新的消息，请注意查收");
...
////
////			if (msgType == 51) {
////				Log.i("wechatserviceimp","成功截获微信初始化消息");
////			} else if (msgType == 1) {
...
////					Log.i("wechatserviceimp","|" + name + "| " + peopleContent[0] + ":\n" + peopleContent[1].replace("<br/>", "\n"));
////				} else {
////					Log.i("wechatserviceimp",name + ": " + content);
////					String ans = robot.talk(content);
////					webwxsendmsg(wechatMeta, ans, msg.getString("FromUserName"));
////					Log.i("wechatserviceimp","自动回复 " + ans);
////				}
////			} else if (msgType == 3) {
...
////			} else if (msgType == 42) {
////				Log.i("wechatserviceimp",name + " 给你发送了一张名片:");
////				Log.i("wechatserviceimp","=========================");
////			}
////		}
////	}
////
